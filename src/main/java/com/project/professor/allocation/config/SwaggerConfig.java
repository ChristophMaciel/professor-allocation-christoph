...
import com.project.professor.allocation.ProfessorAllocationChristophApplication;
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors
						.basePackage(ProfessorAllocationChristophApplication.class.getPackage().getName()))
